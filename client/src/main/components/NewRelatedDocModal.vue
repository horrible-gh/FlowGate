<template>
  <DialogShell :open="true" variant="form" surface-class="dialog-new-related-doc-modal"  @request-close="$emit('close')">
    <template #header>
...
<div
    ...
    <template #footer>
      <DialogFooter :actions="[
        ...
        { id: 'submit-1', role: 'primary', label: t('main.new_related_doc_modal.create'), onSelect: () => submit(), disabled: submitting }
      ]">
