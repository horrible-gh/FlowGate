...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'project/types', redirect: { path: '/settings/project', query: { tab: 'doctypes' } } },
      { path: 'project/path', redirect: { path: '/settings/project', query: { tab: 'paths' } } },
      { path: 'project/numbering', redirect: { path: '/settings/project', query: { tab: 'numbering' } } },
      { path: 'project/templates', redirect: { path: '/settings/project', query: { tab: 'groups' } } },
      { path: 'project', component: ProjectSettingsView, meta: { permission: 'project.settings.read' } },
      { path: 'project/groups', component: GroupManagementView, meta: { permission: 'project.settings.read' } },
    ],
  },
