...
ALTER TABLE snapshot_requests ADD COLUMN stale BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE snapshot_requests ADD COLUMN stale_detected_at TEXT NULL;
ALTER TABLE snapshot_requests ADD COLUMN cleanup_failed BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE snapshot_requests ADD COLUMN copied_byte_size BIGINT NULL;
CREATE INDEX idx_snapshot_requests_cleanup
 ON snapshot_requests(status, expires_at(64), cleanup_next_at(64));
