-- 076a_ai_invoke_paused_provider.sql
...
ALTER TABLE ai_invoke_paused_chains ADD COLUMN continuation_base_provider_id VARCHAR(191) REFERENCES ai_providers(provider_id) ON DELETE SET NULL;
