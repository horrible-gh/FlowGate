...
-- No IF NOT EXISTS (this deployment's MySQL baseline does not support it on ADD
-- COLUMN, same as 086c/095/101) and no AFTER clause.

ALTER TABLE ai_invoke_document_review_loops ADD COLUMN card_dismissed_at VARCHAR(64);
