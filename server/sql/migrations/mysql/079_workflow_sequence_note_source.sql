...
--
-- source_doc_id is VARCHAR(191), matching the result_doc_id column added by 032 in this
-- dialect (utf8mb4 index-length limit). note uses the expression-default form because a
-- MySQL TEXT column cannot carry a literal DEFAULT.

ALTER TABLE workflow_sequence_items
    ADD COLUMN note TEXT NOT NULL DEFAULT ('');

ALTER TABLE workflow_sequence_items
    ADD COLUMN source_doc_id VARCHAR(191) DEFAULT NULL
