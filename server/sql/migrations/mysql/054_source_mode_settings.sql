...
INSERT IGNORE INTO system_settings(setting_key, setting_value, value_type, description, updated_at)
VALUES('source_mode', 'remote', 'string', 'Default project source access mode', UTC_TIMESTAMP());
