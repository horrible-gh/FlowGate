...
-- this dialect's own 105 already used TINYINT(1), matching the writer's None/0/1
-- contract (db/ai_invoke_runs.py upsert()). There is nothing to converge on mysql.
--
