-- 074_document_type_descriptions.sql
...
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
SELECT id, 'ko', description
FROM   document_types
WHERE  description IS NOT NULL AND project_id IS NULL;

-- ── 2. ko/ja/en seed per system type (general series: R, M, Q, A, L, B, CH) ─
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
SELECT id, 'ko', '무엇을·왜 만들지를 정의하는 문서. 기능·비기능 요구사항을 정리한다.'
FROM   document_types WHERE series = 'general' AND type_code = 'R' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'M' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'Q' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'A' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'L' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'B' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'general' AND type_code = 'CH' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'instruction' AND type_code = 'DS' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'instruction' AND type_code = 'N' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'instruction' AND type_code = 'T' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'instruction' AND type_code = 'TS' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'design' AND type_code = 'D' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'design' AND type_code = 'P' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'design' AND type_code = 'L' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'design' AND type_code = 'DB' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'work' AND type_code = 'NR' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'work' AND type_code = 'TR' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'work' AND type_code = 'TSR' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'work' AND type_code = 'V' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'work' AND type_code = 'C' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'action' AND type_code = 'AC' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
...
FROM   document_types WHERE series = 'action' AND type_code = 'RJ' AND project_id IS NULL;
INSERT OR IGNORE INTO document_type_descriptions (document_type_id, locale, description)
