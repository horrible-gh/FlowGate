...
-- SQLite 는 ADD COLUMN 에 CHECK 를 붙일 수 없다(076b 와 같은 판단). 불리언은 0/1 정수.
ALTER TABLE ai_invoke_runs ADD COLUMN worker_document_type TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN continuation_instruction_mode_requested TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN continuation_instruction_mode_normalized TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN continuation_instruction_mode_fallback_applied INTEGER NOT NULL DEFAULT 0;
ALTER TABLE ai_invoke_runs ADD COLUMN auto_handled_item_seqs TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_message_source TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_common_default_applied INTEGER NOT NULL DEFAULT 0;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_user_message_length INTEGER NOT NULL DEFAULT 0;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_user_message_sha256 TEXT;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_final_length INTEGER NOT NULL DEFAULT 0;
ALTER TABLE ai_invoke_runs ADD COLUMN prompt_final_sha256 TEXT;
