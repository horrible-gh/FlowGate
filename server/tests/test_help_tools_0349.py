...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"project": "flowgate", "action_scope": "edit"}, "read_write", ["read", "grep", "glob", "stat", "diff", "log", "show", "write", "patch", "remove"]),
        ({"project": "flowgate", "action_scope": "resolve_base_dirty"}, "read_write", ["read", "grep", "glob", "stat", "diff", "log", "show", "write", "patch", "remove", "resolve_base_dirty"]),
        ({"project": "flowgate", "action_scope": "review"}, "read", ["read", "grep", "glob", "stat", "diff", "log", "show"]),
